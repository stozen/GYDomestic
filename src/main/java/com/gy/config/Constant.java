...
public class Constant {
	 ...
	 * 数据请求返回码
	 */
	public static final int RESCODE_SUCCESS = 0200;				//成功
	public static final int RESCODE_SUCCESS_MSG = 1001;			//成功(有返回信息)
	public static final int RESCODE_EXCEPTION = 0402;			//请求抛出异常
	public static final int RESCODE_NOLOGIN = 1003;				//未登陆状态
	public static final int RESCODE_NOEXIST = 0404;				//查询结果为空
